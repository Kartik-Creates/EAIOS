  ...
  return (
    <div className="not-found-page">
      ...
      <div className="not-found-text-block">
        ...
        <p>
          The requested URL does not match any registered route in the EAIOS application router.
        ...
        <div className="not-found-suggestions">
          ...
          <div className="suggestions-grid">
            <div className="suggestion-card" onClick={() => navigate(ROUTES.CHAT)}>
              <MessageSquare size={18} className="suggestion-icon" />
            ...
            <div className="suggestion-card" onClick={() => navigate(ROUTES.INTEGRATIONS)}>
              <Plug size={18} className="suggestion-icon" />
              <span>Integrations</span>
            </div>

            {user?.role === 'admin' && (
              <div className="suggestion-card" onClick={() => navigate(ROUTES.ADMIN)}>
                <ShieldCheck size={18} className="suggestion-icon" />
